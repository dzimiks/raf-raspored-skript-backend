...
urlpatterns = [
    ...
    path('informacijeOstudentu/<str:username>', views.informacijeOStudentu,
         name="informacije_o_studentu"),
    ...
    path('upload_rasporeda/<str:username>', views.upload_raspored_nastave, name='upload_form'),
    path('upload_raspored', views.upload_raspored, name='upload_raspored'),
    path('upload_rasporeda_retry/<str:username>', views.upload_raspored_nastave_retry,
         name='upload_form_retry'),
    path('upload_raspored_retry', views.upload_raspored_retry, name='upload_raspored_retry'),
